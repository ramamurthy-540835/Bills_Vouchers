...
def gst_health_score(*, pending_returns: int, overdue_returns: int, mismatch_count: int, itc_at_risk: float, approval_pending: int) -> int:
    ...
    if itc_at_risk > 0:
        deductions += min(20, int(itc_at_risk // 50_000) + 1)
