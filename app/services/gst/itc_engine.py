...
def compute_itc(data: dict) -> dict:
    ...
    totals = {h: {"gross": ZERO, "ineligible_17_5": ZERO, "ineligible_16_2": ZERO, "reversal_rule_42": ZERO, "reversal_rule_43": ZERO, "reversal_rule_37": ZERO, "reclaimed": ZERO, "net_eligible": ZERO, "deferred_to_next": ZERO} for h in HEADS}
    lines, warnings = [], []
    today = date.today()
