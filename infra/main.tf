...
locals {
  tables={
    ...
    users=[{name="id",type="STRING",mode="REQUIRED"},{name="email",type="STRING"},{name="password_hash",type="STRING"},{name="must_change_password",type="BOOL"},{name="full_name",type="STRING"},{name="role",type="STRING"},{name="is_active",type="BOOL"},{name="created_at",type="TIMESTAMP"}],
